...
public:
	union {
		...
		//armorValue
		DEFINE_MEMBER_N(int, armorValue, 0xB378);
		//aimPunchAngle
		DEFINE_MEMBER_N(Vec3, aimPunchAngle, 0x302C);
		//angEyeAnglesX
		DEFINE_MEMBER_N(float, angEyeAnglesX, 0xB37C);
		//angEyeAnglesY
		DEFINE_MEMBER_N(float, angEyeAnglesY, 0xB380);
		//vecVelocity
		DEFINE_MEMBER_N(Vec3, vecVelocity, 0x114);
		//bHasHelmet
		DEFINE_MEMBER_N(bool, bHasHelmet, 0xB36C);
	};
...
public:
	...
	uintptr_t dwViewMatrix = 0x4D45E54;
	...
	struct Colors {
		...
		struct Team {
			...
			D3DCOLOR headline = D3DCOLOR_ARGB(255, 0, 255, 0);
		}team;
		struct Enemy {
